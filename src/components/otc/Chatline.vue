  ...
  <div>
    <div class="chat-line">
      <div class="scroll-chat" id="scrollChat">
        ...
        <h5
          class="more"
          v-show="currentPage < totalPage || currentPage == totalPage"
        >
                ...
                <div class="avatar-box">
                  <div class="user-face user-avatar-public">
                    <span
                      ...
                      v-if="
                        typeof item.fromAvatar == 'undefined' ||
...
export default {
  ...
  methods: {
    ...
    connect: function() {
      ...
      stompClient.connect({}, function(frame) {
        stompClient.subscribe(
          "/user/" + self.msg.myId + "/" + self.orderId,
          function(response) {
    ...
    getBefore: function(page) {
      ...
      this.$http
        .post(this.host + "/chat/getHistoryMessage", params)
        .then((response) => {
          var resp = response.body;
          this.totalPage = resp.totalPage;
          if (resp.data) {
            if (
              this.currentPage < resp.totalPage ||
              this.currentPage == resp.totalPage
            ) {
              this.showMore = true;
