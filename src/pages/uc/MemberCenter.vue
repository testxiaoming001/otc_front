...
<template>
  <div class="mymsg_wrapper">
        ...
        <Col :xs="24" :sm="24" :md="4" :lg="4">
          ...
          >
            ...
            <Submenu name="1">
              ...
              <MenuItem name="1-2">
                <router-link to="/uc/account">{{
                  $t("uc.member.accountsetting")
                }}</router-link>
              </MenuItem>
            </Submenu>
            <Submenu name="2">
              ...
              <MenuItem name="2-1">
                <router-link to="/uc/money">{{
                  $t("uc.finance.personalassets")
                }}</router-link>
              </MenuItem>
              <MenuItem name="2-2">
                <router-link to="/uc/record">{{
                  $t("uc.finance.billdetail")
                }}</router-link>
              </MenuItem>
              <MenuItem name="2-3">
                <router-link to="/uc/recharge">{{
                  $t("uc.finance.charge")
                }}</router-link>
              </MenuItem>
              <MenuItem name="2-4">
                <router-link to="/uc/withdraw">{{
                  $t("uc.finance.pickup")
                }}</router-link>
              </MenuItem>
            </Submenu>
            <Submenu name="3">
              ...
              <MenuItem name="3-1">
                <router-link to="/uc/entrust/current">{{
                  $t("uc.member.curdelegate")
                }}</router-link>
              </MenuItem>
              <MenuItem name="3-2">
                <router-link to="/uc/entrust/history">{{
                  $t("uc.member.hisdelegate")
                }}</router-link>
              </MenuItem>
            </Submenu>
            <Submenu name="4">
    ...
    <Drawer
      :closable="true"
      width="40"
      v-model="ucNavDrawerModal"
      class="header_nav_mobile uc_header_nav"
    >
      <Menu
        :active-name="activename"
        :open-names="opennames"
      ...
      >
        ...
        <Submenu name="5">
          ...
          <MenuItem name="5-1">
            <router-link to="/uc/promotion/mypromotion">{{
              $t("uc.promotion.subtitle3")
            }}</router-link>
          </MenuItem>
          <MenuItem name="5-2">
            <router-link to="/uc/promotion/mycards">{{
              $t("uc.promotion.subtitle1")
            }}</router-link>
          </MenuItem>
        </Submenu>
        <Submenu name="6">
          ...
          <MenuItem name="6-1">
            <router-link to="/uc/innovation/myorders">{{
              $t("uc.activity.subNavTitle1")
            }}</router-link>
          </MenuItem>
          <MenuItem name="6-2">
            <router-link to="/uc/innovation/myminings">{{
              $t("uc.activity.subNavTitle2")
            }}</router-link>
          </MenuItem>
        </Submenu>
      </Menu>
