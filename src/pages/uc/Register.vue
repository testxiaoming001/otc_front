  ...
  <div class="login_form">
    ...
    display: inline-block;cursor: pointer;"
        ...
        <div class="check-agree" style="">
          ...
          <a
            v-if="lang == '简体中文'"
            href="/helpdetail?cate=1&id=5&cateTitle=常见问题"
            target="_blank"
            style=""
          ...
          <a
            v-if="lang == 'English'"
            href="/helpdetail?cate=1&id=35&cateTitle=Privacy Policy"
            target="_blank"
            style=""
            >《{{ $t("uc.regist.userprotocol") }}》</a
          >
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          if (this.agree == true) {
            ...
            params["re_password"] = this.formInline.repassword;
            params["verfy_code"] = this.formInline.verfy_code;
            this.$http
              .post(this.apiHost+"/index/user_register", params)
              .then((response) => {
